...
public interface IO {
	...
	/**
	 * Lädt die Liste aller Orts-Details aus der places-Datei im Spiel-Verzeichnis.
	 * Tritt dabei ein Fehler auf, wird eine InvalidGameException geworfen.
	 */
	public List<Place> loadPlaces() throws InvalidGameException;

	/**
	 * Erzeugt eine World-Instanz aus den Informationen der World-Datei im Spiel-Verzeichnis
	 * und der Liste aller Orte. Tritt dabei ein Fehler auf, wird eine InvalidGameException geworfen.
	 */
